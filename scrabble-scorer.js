...
function transform(scoreStructure) {
  let newPointStructure = {}
  for (item in scoreStructure){
    for (i = 0; i < scoreStructure[item].length; i++){
      newPointStructure[scoreStructure[item][i].toLowerCase()] = Number(item) 
    }
  }
